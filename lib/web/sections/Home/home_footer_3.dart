...
import '../TestimonialTile.dart';

class HomeFooter3 extends StatefulWidget {
  final double pixels;
  const HomeFooter3({Key? key, required this.pixels}) : super(key: key);

  @override
  State<HomeFooter3> createState() => _HomeFooter3State();
}

class _HomeFooter3State extends State<HomeFooter3> {
  @override
